...
export function Header({ onAboutOpen } = {}) {
  ...
  header.innerHTML = `
    <a class="site-brand" href="/" data-route-link="selection" aria-label="Martin Motion, accueil">
      <img src="./assets/logo/martinmotion-logo-loop-alpha.webp?v=20260718" alt="" width="40" height="40" />
    </a>
    <nav class="site-nav" aria-label="Navigation principale">
      <a class="site-nav__link" href="/" data-route-link="selection">Galerie</a>
  ...
  header.querySelectorAll("a").forEach((link) => makeMagnetic(link, 0.16));
  ...
  return { element: header, setActiveRoute };
}
