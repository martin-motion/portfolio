...
const getDepth = (offset) => {
  ...
  const depth = [
    ...
    { scale: 0.8, veil: 0.14, brightness: 0.92, saturation: 0.96, opacity: 0.95, rotate: 15, y: 10, z: -40, xOffset: 1 },
    { scale: 0.6, veil: 0.28, brightness: 0.82, saturation: 0.9, opacity: 0.6, rotate: 30, y: 15, z: -180, xOffset: 1.55 },
    { scale: 0.45, veil: 0.44, brightness: 0.72, saturation: 0.84, opacity: 0.2, rotate: 45, y: 20, z: -300, xOffset: 1.9 },
    { scale: 0.3, veil: 0.6, brightness: 0.6, saturation: 0.7, opacity: 0, rotate: 60, y: 25, z: -420, xOffset: 2.15 },
  ];
